...
export default function LoyalCustomersBlock({ customers, contactActions, onOpenCustomer, onOpenCommunication }) {
  return (
    <section style={styles.card}>
      <div style={styles.panelHeader}>
        <h3 style={styles.subTitle}>Clients fidèles</h3>
        <p style={styles.muted}>Clients ayant plusieurs séjours ou une valeur élevée.</p>
      </div>

      {customers.length === 0 ? (
        <p style={styles.empty}>Aucun client fidèle détecté.</p>
      ) : (
